    ...
    >
      ...
      >
        <button
          ...
          onClick={onClose}
          className="absolute right-4 hover:cursor-pointer top-4 flex size-8 items-center justify-center rounded-full bg-[#EAEEE4]/[0.05] transition hover:bg-[#EAEEE4]/10"
        >
