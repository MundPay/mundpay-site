...
type PrimaryCtaLinkProps = ComponentPropsWithoutRef<'a'>
...
export function PrimaryCtaLink({ children, className, ...props }: PrimaryCtaLinkProps) {
  return (
    <a className={twMerge(primaryCtaClassName, className)} {...props}>
